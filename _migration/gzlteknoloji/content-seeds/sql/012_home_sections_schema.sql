...
DELETE FROM `home_sections` WHERE `id` = 'home-konular' OR `component_key` = 'ZodiacGridSection';

INSERT INTO `home_sections` (`id`, `slug`, `label`, `component_key`, `order_index`, `is_active`, `config`) VALUES
('home-hero', 'hero', 'Hero', 'HeroNew', 10, 0, NULL),
('home-kanallar', 'kanallar', 'Satış kanalları', 'SalesChannelsSection', 20, 0, NULL),
('home-neden', 'neden', 'Neden GZL Teknoloji', 'FeaturesNew', 30, 0, NULL),
('home-nasil', 'nasil', 'Nasıl çalışır', 'HomeIntroSection', 40, 0, NULL),
