    ...
    <section class="skills" id="skills">
      ...
      <div class="skill-flex">
        ...
        <div class="skill-item">
          ...
          <div class="icon-card"><img src="assets/tailwindcss.png" alt="Tailwind CSS" class="skill-icon" /><p>Tailwind CSS</p></div>
        ...
        <div class="skill-item">
          ...
          <div class="icon-card"><img src="assets/nodejs.png" alt="Node.js" class="skill-icon" /><p>Node.js</p></div>
          ...
          <div class="icon-card"><img src="assets/jest.png" alt="Jest" class="skill-icon" /><p>Jest</p></div>
        ...
        <div class="skill-item">
          ...
          <div class="icon-card"><img src="assets/docker.png" alt="Docker" class="skill-icon" /><p>Docker</p></div>
          <div class="icon-card"><img src="assets/vercel.png" alt="Vercel" class="skill-icon" /><p>Vercel</p></div>
        </div>
