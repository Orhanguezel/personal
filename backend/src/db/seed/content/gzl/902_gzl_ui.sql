...
INSERT INTO `site_settings` (`id`, `key`, `locale`, `value`) VALUES
  ('cd192947-172a-5126-80df-d0babbeb6022', 'ui_home', 'tr', '{"home1": {"greeting": "Merhaba, biz GZL Teknoloji", "title_html": "GZL Teknoloji — <span class=\\"text-primary-1\\">Yazılım ve Dijital Çözümler</span>", "description": "Yazılım ve dijital danışmanlık şirketiyiz. Özel yazılım, kurumsal web ve e-ticaret, iş süreçleri otomasyonu, yapay zekâ entegrasyonu ve GEO/SEO danışmanlığı sunuyoruz.", "cta_primary": "Teklif alın", "cta_secondary": "Projelerimiz", "experience_label": "21 tamamlanmış proje", "hero_image": "/uploads/site-media/hero-workspace.webp", "hero_image_alt": "Yazılım geliştirme çalışma masası", "cta_primary_href": "/contact"}, "home2": {"greeting": "Merhaba, biz GZL Teknoloji", "title_html": "<span class=\\"text-linear-4\\">GZL</span> Teknoloji<span class=\\"flicker\\">_</span>", "description_html": "<p>Kurumsal web sitesi ve e-ticaretten ERP, CRM ve otomasyon panellerine kadar üretime hazır sistemler geliştiriyoruz. Proje kod tesliminde değil, sunucuda sorunsuz çalıştığında biter.</p>", "hero_image": "/uploads/site-media/hero-workspace.webp", "hero_image_alt": "Yazılım geliştirme çalışma masası"}}')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = CURRENT_TIMESTAMP(3);
...
INSERT INTO `site_settings` (`id`, `key`, `locale`, `value`) VALUES
  ('28336ca4-0532-54f1-96ec-daa0a6a67510', 'ui_home', 'en', '{"home1": {"greeting": "Hello, we are GZL Technology", "title_html": "GZL Technology — <span class=\\"text-primary-1\\">Software and Digital Solutions</span>", "description": "We are a software and digital consultancy. We deliver custom software, corporate web and e-commerce, business process automation, AI integration and GEO/SEO consulting.", "cta_primary": "Request a quote", "cta_secondary": "Our work", "experience_label": "21 completed projects", "hero_image": "/uploads/site-media/hero-workspace.webp", "hero_image_alt": "Software development workspace", "cta_primary_href": "/contact"}, "home2": {"greeting": "Hello, we are GZL Technology", "title_html": "<span class=\\"text-linear-4\\">GZL</span> Technology<span class=\\"flicker\\">_</span>", "description_html": "<p>From corporate websites and e-commerce to ERP, CRM and automation panels, we build production-ready systems. A project is not done when the code ships — it is done when it runs reliably in production.</p>", "hero_image": "/uploads/site-media/hero-workspace.webp", "hero_image_alt": "Software development workspace"}}')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = CURRENT_TIMESTAMP(3);
...
INSERT INTO `site_settings` (`id`, `key`, `locale`, `value`) VALUES
  ('cb9750d3-b665-5ae9-95e2-40f5ed4f2b78', 'ui_home', 'de', '{"home1": {"greeting": "Hallo, wir sind GZL Technologie", "title_html": "GZL Technologie — <span class=\\"text-primary-1\\">Software und digitale Lösungen</span>", "description": "Wir sind eine Software- und Digitalberatung. Wir liefern individuelle Software, Unternehmenswebsites und E-Commerce, Prozessautomatisierung, KI-Integration sowie GEO/SEO-Beratung.", "cta_primary": "Angebot anfordern", "cta_secondary": "Unsere Projekte", "experience_label": "21 abgeschlossene Projekte", "hero_image": "/uploads/site-media/hero-workspace.webp", "hero_image_alt": "Software-Entwicklungsarbeitsplatz", "cta_primary_href": "/contact"}, "home2": {"greeting": "Hallo, wir sind GZL Technologie", "title_html": "<span class=\\"text-linear-4\\">GZL</span> Technologie<span class=\\"flicker\\">_</span>", "description_html": "<p>Von Unternehmenswebsites und E-Commerce bis zu ERP-, CRM- und Automatisierungspanels bauen wir produktionsreife Systeme. Ein Projekt endet nicht mit der Codeübergabe, sondern wenn es im Betrieb zuverlässig läuft.</p>", "hero_image": "/uploads/site-media/hero-workspace.webp", "hero_image_alt": "Software-Entwicklungsarbeitsplatz"}}')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = CURRENT_TIMESTAMP(3);
...
-- ── Offcanvas (hamburger) paneli ────────────────────────────────────────────
-- GZL'de bu anahtar yoktu; panel acildiginda API 404 donuyor ve bolum bos
-- kaliyordu (konsolda: site_settings/offcanvas_panel?locale=tr 404).

INSERT INTO `site_settings` (`id`, `key`, `locale`, `value`) VALUES
  ('d95cfd8b-7a56-5706-ba77-cbfd257c0bfb', 'offcanvas_panel', 'tr', '{"headline": "İletişime geçin", "intro": "Projenizi konuşalım. Kapsam, teslim süresi ve fiyat yazılı olarak netleşsin."}')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = CURRENT_TIMESTAMP(3);

INSERT INTO `site_settings` (`id`, `key`, `locale`, `value`) VALUES
  ('c17e537d-b6f6-536d-9820-18da6b4e6c7f', 'offcanvas_panel', 'en', '{"headline": "Get in touch", "intro": "Let us talk about your project. Scope, delivery time and price agreed in writing."}')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = CURRENT_TIMESTAMP(3);

INSERT INTO `site_settings` (`id`, `key`, `locale`, `value`) VALUES
  ('aa6cdd2b-9322-5b33-a744-893f7a992335', 'offcanvas_panel', 'de', '{"headline": "Kontakt aufnehmen", "intro": "Sprechen wir über Ihr Projekt. Umfang, Lieferzeit und Preis schriftlich vereinbart."}')
ON DUPLICATE KEY UPDATE `value` = VALUES(`value`), `updated_at` = CURRENT_TIMESTAMP(3);
