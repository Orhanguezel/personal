...
-- Gerekce : Kurumsal/hakkimizda icerigi (plan madde 9)
--
...
INSERT INTO custom_pages_i18n (`id`,`page_id`,`locale`,`title`,`slug`,`content`,`summary`,`meta_title`,`meta_description`) VALUES
  ('a0ec7c0f-9bba-4d2c-a518-63f3acb8ab3f','41000000-0000-4000-8000-000000000101','tr','Mesafeli Satış Sözleşmesi','mesafeli-satis-sozlesmesi','<blockquote><p>TASLAK — yayına almadan önce avukat onayı gereklidir. Hukuki danışmanlık teşkil etmez.</p></blockquote>
...
<p>---</p>','TASLAK — avukat onayı sonrası yayınlanacaktır.','Mesafeli Satış Sözleşmesi','TASLAK — avukat onayı sonrası yayınlanacaktır.'),
  ('2191df3c-b59d-4864-9074-fa800048ccd8','41000000-0000-4000-8000-000000000101','en','Distance Sales Agreement','distance-sales-agreement','<blockquote><p>DRAFT — attorney review is required before publication. This document does not constitute legal advice.</p></blockquote>
...
<li><strong>Legislation:</strong> Turkish Law No. 6502 on the Protection of Consumers; Regulation on Distance Contracts (withdrawal period, refund period, service-performance exceptions); Turkish Commercial Code No. 6102 and Code of Obligations No. 6098 (non-consumer buyers). Article numbers of the Regulation were deliberately omitted — verification notes are in <code>docs/icerik/_tmp/EKSIK_legal.md</code>.</li>
  ...
  ('6984a183-3e2c-403f-bf05-afac9a6896e5','41000000-0000-4000-8000-000000000102','tr','Ön Bilgilendirme Formu','on-bilgilendirme-formu','<blockquote><p>TASLAK — yayına almadan önce avukat onayı gereklidir. Hukuki danışmanlık teşkil etmez.</p></blockquote>
...
<p>---</p>','TASLAK — avukat onayı sonrası yayınlanacaktır.','Ön Bilgilendirme Formu','TASLAK — avukat onayı sonrası yayınlanacaktır.'),
  ('35633112-29cd-4c04-9730-c71622e40006','41000000-0000-4000-8000-000000000102','en','Preliminary Information Form','preliminary-information-form','<blockquote><p>DRAFT — attorney review is required before publication. This document does not constitute legal advice.</p></blockquote>
...
<li><strong>Legislation:</strong> Law No. 6502 and the Regulation on Distance Contracts (preliminary information duty, 14-day withdrawal period, model withdrawal form, exceptions). Article numbers deliberately omitted — see <code>docs/icerik/_tmp/EKSIK_legal.md</code>.</li>
  ...
  ('4838ea22-8510-4f47-b9a9-6ac36b838765','41000000-0000-4000-8000-000000000103','tr','İade ve Teslimat Koşulları','iade-ve-teslimat','<blockquote><p>TASLAK — yayına almadan önce avukat onayı gereklidir. Hukuki danışmanlık teşkil etmez.</p></blockquote>
...
<p>---</p>','TASLAK — avukat onayı sonrası yayınlanacaktır.','İade ve Teslimat Koşulları','TASLAK — avukat onayı sonrası yayınlanacaktır.'),
  ('d906bfd6-d9a4-4cdb-bb53-503c624fc50a','41000000-0000-4000-8000-000000000103','en','Refund and Delivery Terms','refund-and-delivery-terms','<blockquote><p>DRAFT — attorney review is required before publication. This document does not constitute legal advice.</p></blockquote>
...
<li><strong>Legislation:</strong> Law No. 6502 and the Regulation on Distance Contracts (withdrawal period, refund period, service exceptions, partial performance). The revision request window (14 days) is a <strong>commercial suggestion</strong>, not a statutory rule — see <code>docs/icerik/_tmp/EKSIK_legal.md</code>.</li>
  ...
  ('b3295025-487f-4fd0-ba94-8411f1966337','41000000-0000-4000-8000-000000000104','tr','Ticari Elektronik İleti Onayı','ticari-elektronik-ileti-onayi','<blockquote><p>TASLAK — yayına almadan önce avukat onayı gereklidir. Hukuki danışmanlık teşkil etmez.</p></blockquote>
...
<p>---</p>','TASLAK — avukat onayı sonrası yayınlanacaktır.','Ticari Elektronik İleti Onayı','TASLAK — avukat onayı sonrası yayınlanacaktır.'),
  ('7c55bb14-09f5-430c-a602-18043f8066ef','41000000-0000-4000-8000-000000000104','en','Commercial Electronic Message Consent','commercial-electronic-message-consent','<blockquote><p>DRAFT — attorney review is required before publication. This document does not constitute legal advice.</p></blockquote>
