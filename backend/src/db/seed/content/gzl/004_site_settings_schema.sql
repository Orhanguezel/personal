...
-- Kaynak  : _migration/gzlteknoloji/content-seeds/sql/004_site_settings_schema.sql
-- Gerekce : GZL marka degerleri, iletisim, SEO (plan madde 10)
--
...
('ss-ga4-measurement-id', 'ga4_measurement_id', '*', '"G-CCJDDYXB3Y"'),
('ss-google-site-verification', 'google_site_verification', '*', '""'),
('ss-gtm-container-id', 'gtm_container_id', '*', '"GTM-NXQQ5GMT"'),
...
('ss-socials',           'socials',           '*', '{}'),
('ss-company-brand',     'company_brand',     '*', '{"name":"GZL Danışmanlık Hizmetleri ve Teknoloji Limited Şirketi","short_name":"GZL Teknoloji","website":"https://gzlteknoloji.com","phone":"","email":"info@gzlteknoloji.com","descriptions":{"tr":"yazılım, dijital çözüm ve teknoloji şirketi.","en":"A software, digital solutions and technology company based in Gemlik and Bursa."},"socials":{},"legal":{"vergi_dairesi":"Gemlik","vergi_no":"4542302453","mersis":"0454230245300001","ticaret_sicil":"7069 (Gemlik)","adres":"Cumhuriyet Mah. Hastane Cad. Şahinler Sit. C Blok No:12-C İç Kapı No:14 Gemlik/Bursa"}}'),
