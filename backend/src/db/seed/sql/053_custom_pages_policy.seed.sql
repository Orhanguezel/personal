...
(
  ...
  CONCAT(
    ...
    REPLACE(REPLACE(REPLACE(CONCAT(
      ...
      '<h3>Kontakt</h3>',
      '<p>E-Mail: info@guezelwebdesign.com<br>Telefon: +49 172 384 6068<br>Website: https://www.guezelwebdesign.com</p>',
...
(
  ...
  CONCAT(
    ...
    REPLACE(REPLACE(REPLACE(CONCAT(
      ...
      '<h3>Contact</h3>',
      '<p>Email: info@guezelwebdesign.com<br>Phone: +49 172 384 6068<br>Website: https://www.guezelwebdesign.com</p>',
...
(
  ...
  CONCAT(
    ...
    REPLACE(REPLACE(REPLACE(CONCAT(
      ...
      '<p>E-posta: info@guezelwebdesign.com<br>Telefon: +49 172 384 6068<br>Web sitesi: https://www.guezelwebdesign.com</p>',
