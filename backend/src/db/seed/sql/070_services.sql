-- =============================================================
-- 070_services.sql  (schema) — FE Services page protocol
-- - NO category/sub_category
-- - services: parent (status/order/cover)
-- - services_i18n: slug/name/summary/content/meta
-- - optional gallery tables
-- =============================================================
...
-- ================= TABLE: service_images_i18n (optional) =================
