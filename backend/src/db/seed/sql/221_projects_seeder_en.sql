...
INSERT INTO `projects` (
  ...
  CAST('["Backend Development","Admin Panel","Architecture & Optimization"]' AS CHAR), NULL, CAST('["Bun","TypeScript","Fastify","Drizzle ORM","MySQL","Next.js","React","React Query","Redux Toolkit","JWT","Nginx","CI/CD","Zustand","Tailwind CSS","Radix UI","Zod","Cloudinary","Nodemailer","Sass"]' AS CHAR), CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3)
);
...
INSERT INTO `projects` (
  ...
  @p5, 1, 1, 5,
  1000.00, 'USD', 1,
  '/assets/imgs/work/img-3.png', @asset5, 'http://72.61.21.20/auth/login', 'https://github.com/Orhanguezel/sunplex',
  'ERP', 'SUNPLEX (ENES OTO)', '2026-05-22', NULL, 'Ongoing',
  CAST('["Backend Development","Admin Panel","ERP Integration","Architecture & Optimization"]' AS CHAR), 'http://72.61.21.20', CAST('["Bun","TypeScript","Fastify","Drizzle ORM","MySQL","Next.js","React","React Query","Redux Toolkit","JWT","Zod","PM2","Nginx","CI/CD","Zustand","Tailwind CSS","Radix UI","Cloudinary","Nodemailer"]' AS CHAR), CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3)
);
...
INSERT INTO `projects_i18n` (
  ...
  @pi18n8, @p8, 'en', 'Menu SaaS — Çok Kiracılı Restoran Sipariş Platformu', 'menu', 'Lieferando benzeri çok kiracılı restoran sipariş platformu: QR masa siparişi, paket servis/gel-al, marketplace, kurye yönetimi, mutfak ekranı ve mobil uygulama. Schema-per-tenant mimari — her restoran kendi veritabanında.',
...
INSERT INTO `projects` (
  ...
  @p10, 1, 0, 10,
  1000.00, 'USD', 1,
  '/assets/imgs/work/projects/paketjet.png', @asset10, 'https://paketjet.com', NULL,
...
INSERT INTO `projects_i18n` (
  ...
  @pi18n10, @p10, 'en', 'PaketJet', 'paketjet', 'P2P cargo freight marketplace — carriers post route & capacity listings, customers book cargo space. BlaBlaCar model applied to freight logistics.',
...
INSERT INTO `project_images` (`id`, `project_id`, `asset_id`, `image_url`, `display_order`, `is_active`, `created_at`, `updated_at`) VALUES
(@img10, @p10, @asset10, '/assets/imgs/work/projects/paketjet.png', 0, 1, CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));

INSERT INTO `project_images_i18n` (`id`, `image_id`, `locale`, `alt`, `caption`, `created_at`, `updated_at`) VALUES
(@imgI18n10, @img10, 'en', 'PaketJet', 'Primary project visual', CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));
...
INSERT INTO `projects` (
  ...
  @p11, 1, 0, 11,
  1000.00, 'USD', 1,
  '/assets/imgs/work/img-2.png', @asset11, 'https://agrodukkan.com', 'https://github.com/Orhanguezel/agrodukkan',
  'E-COMMERCE', 'Own Project — Tarim Dijital Ekosistemi', '2026-05-14', NULL, 'Gelistirme',
  CAST('["E-Commerce Architecture","Backend Development","Frontend Development","Google Merchant / Shopping","SEO / GEO"]' AS CHAR), 'https://agrodukkan.com', CAST('["Laravel","PHP","Next.js","React","Redux Toolkit","MySQL","iyzico","Netgsm","Fastify","JWT","JavaScript","Sass","TypeScript","Tailwind CSS"]' AS CHAR), CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3)
);
...
INSERT INTO `project_images_i18n` (`id`, `image_id`, `locale`, `alt`, `caption`, `created_at`, `updated_at`) VALUES
(@imgI18n11, @img11, 'en', 'Agro Dükkan', 'Primary project visual', CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));
...
INSERT INTO `projects` (
  ...
  @p13, 1, 0, 13,
  1000.00, 'USD', 1,
  '/assets/imgs/work/img-4.png', @asset13, NULL, NULL,
...
INSERT INTO `projects_i18n` (
  ...
  @pi18n13, @p13, 'en', 'Amozon', 'amozon', 'Amazon kategorilerinde 5 boyutlu risk skoru + LLM reasoning ile açıklanabilir AL/TAKIP_ET/UZAK_DUR karar motoru.',
...
INSERT INTO `project_images` (`id`, `project_id`, `asset_id`, `image_url`, `display_order`, `is_active`, `created_at`, `updated_at`) VALUES
(@img13, @p13, @asset13, '/assets/imgs/work/img-4.png', 0, 1, CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));

INSERT INTO `project_images_i18n` (`id`, `image_id`, `locale`, `alt`, `caption`, `created_at`, `updated_at`) VALUES
(@imgI18n13, @img13, 'en', 'Amozon', 'Primary project visual', CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));
...
INSERT INTO `projects` (
  ...
  @p14, 1, 0, 14,
  1000.00, 'USD', 1,
  '/assets/imgs/work/market-pulse-cover.png', @asset14, NULL, NULL,
...
INSERT INTO `projects_i18n` (
  ...
  @pi18n14, @p14, 'en', 'MarketPulse', 'market-pulse', 'Türk distribütörleri için bayi izleme, lead yönetimi ve rakip analiz SaaS platformu. Scraper destekli otomatik sinyal üretimi.',
...
INSERT INTO `project_images` (`id`, `project_id`, `asset_id`, `image_url`, `display_order`, `is_active`, `created_at`, `updated_at`) VALUES
(@img14, @p14, @asset14, '/assets/imgs/work/market-pulse-cover.png', 0, 1, CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));

INSERT INTO `project_images_i18n` (`id`, `image_id`, `locale`, `alt`, `caption`, `created_at`, `updated_at`) VALUES
(@imgI18n14, @img14, 'en', 'MarketPulse', 'Primary project visual', CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3));
