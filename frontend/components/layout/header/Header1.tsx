        ...
        <>
            <header>
                <nav className={`navbar navbar-expand-lg navbar-light w-100 flex-nowrap z-999 p-0 ${scroll ? "navbar-stick" : ""}`} style={{ position: `${scroll ? "fixed" : "relative"}`, top: `${scroll ? "0" : "auto"}` }}>
                    <a href="#" className="navbar-menu p-4 text-center square-100 menu-tigger icon_80 icon-shape d-none d-md-flex" data-bs-target=".offCanvas__info" aria-controls="offCanvas__info" onClick={handleOffCanvas} aria-label="Open menu">
                    ...
                    <div className="container py-3 px-0">
                        ...
                        <div className="navbar-social d-flex align-items-center pe-5 pe-lg-0 me-5 me-lg-0">
                            ...
                            <div className="burger-icon burger-icon-white border rounded-3" onClick={handleMobileMenu} role="button" tabIndex={0} aria-label="Toggle navigation menu">
