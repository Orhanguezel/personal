// frontend/components/blog/BlogCard1.tsx
...
export default function BlogCard1({
  ...
  // image: prefer effective urls, then legacy, then fallback
  const img =
    ...
    '/assets/imgs/blog/blog-1/img-1.webp';
  ...
  return (
    <>
      <Link href={href}>
        <img src={img} alt={alt} className="img-fluid" width={400} height={260} loading="lazy" decoding="async" />
      </Link>
