...
export default function Home1({
	...
	const heroSrc = String(copy.hero_image || '').trim() || '/assets/imgs/guezel-showcase/workspace_guezel_web_design.webp';
	const heroAlt = String(copy.hero_image_alt || '').trim() || 'Guezel Web Design workspace showcase';
		...
		<>
			...
			<section className="section-hero-1 position-relative pt-200 pb-120 overflow-hidden">
						...
						<div className="col-lg-6 col-md-12">
							...
							<div className="d-flex gap-3">
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900">
									<Image src="/assets/imgs/hero/hero-1/brand-1.webp" alt="Next.js logo" width={64} height={64} sizes="64px" style={{ objectFit: 'contain', height: 'auto' }} />
								</div>
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900">
									<Image src="/assets/imgs/hero/hero-1/brand-2.webp" alt="React logo" width={64} height={64} sizes="64px" style={{ objectFit: 'contain', height: 'auto' }} />
								</div>
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900">
									<Image src="/assets/imgs/hero/hero-1/brand-3.webp" alt="TypeScript logo" width={64} height={64} sizes="64px" style={{ objectFit: 'contain', height: 'auto' }} />
								</div>
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900">
									<Image src="/assets/imgs/hero/hero-1/brand-4.webp" alt="Laravel logo" width={64} height={64} sizes="64px" style={{ objectFit: 'contain', height: 'auto' }} />
								</div>
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900">
									<Image src="/assets/imgs/hero/hero-1/brand-5.webp" alt="Flutter logo" width={64} height={64} sizes="64px" style={{ objectFit: 'contain', height: 'auto' }} />
								</div>
								<div className="brand-logo icon-xl icon-shape rounded-3 bg-900 d-none d-md-flex">
									<Image src="/assets/imgs/hero/hero-1/brand-6.webp" alt="MySQL logo" width={64} height={64} sizes="64px" style={{ objectFit: 'contain', height: 'auto' }} />
								</div>
							</div>
						</div>
					</div>
				...
				<div
					...
					style={{ backgroundImage: 'url(/assets/imgs/hero/hero-1/background.webp)' }}
				/>
			</section>
