          ...
          <div className="row align-items-center">
            <div className="col-lg-7 pb-5 pb-lg-0">
              <div className="position-relative">
                <div className="position-relative z-2">
                  <h3 className="text-primary-2 mb-3">{section.headline || copy.headline}</h3>
            ...
            <div className="col-lg-5 d-flex flex-column ps-lg-8">
              ...
              <div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
                ...
                <div className="ps-3 h-100">
                  <span className="text-400 fs-6">{section.cards?.email_label || copy.email}</span>
              ...
              <div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
                ...
                <div className="ps-3 h-100">
                  <span className="text-400 fs-6">{section.cards?.address_label || copy.address}</span>
