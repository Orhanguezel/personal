...
export default function Blog2({ locale = 'en' }: { locale?: string }) {
    ...
    const cards = [
        { img: '/assets/imgs/home-page-2/blog/img-1.webp', cat: ui.blog2.card1_category, title: ui.blog2.card1_title, desc: ui.blog2.card1_description },
        { img: '/assets/imgs/home-page-2/blog/img-2.webp', cat: ui.blog2.card2_category, title: ui.blog2.card2_title, desc: ui.blog2.card2_description },
        { img: '/assets/imgs/home-page-2/blog/img-3.webp', cat: ui.blog2.card3_category, title: ui.blog2.card3_title, desc: ui.blog2.card3_description },
    ];
