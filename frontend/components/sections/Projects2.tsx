// frontend/components/sections/Projects2.tsx
'use client'
...
import { normalizeUiProjectSettingValue, sanitizeHtml } from '@/integrations/shared'
...
export default function Projects2({ locale }: { locale: string }) {
		...
		<>
			...
			<div className="section-projects-2 pt-5">
				<div className="container">
					<div className="rounded-3 border position-relative overflow-hidden">
						<div className="box-linear-animation position-relative z-1">
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								<div className="d-flex align-items-center">
									...
									<span className="text-linear-4 d-flex align-items-center"> {ui.projects2.badge} </span>
								</div>
								<h3 className="text-dark">{ui.projects2.heading}</h3>
												...
												<div className="p-lg-5 p-md-4 p-3 border mt-5 bg-3">
													<div className="row">
														<div className="col-lg-5">
															<img className="w-100" src="/assets/imgs/home-page-2/projects/img-1.webp" alt="zelio" />
														</div>
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4
																className="text-linear-4"
																dangerouslySetInnerHTML={{ __html: sanitizeHtml(ui.projects2.slide_title_html) }}
															/>
															<p>{ui.projects2.slide_description}</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">{ui.projects2.info_label}</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">{ui.projects2.client_label}</p>
																		<p className="text-300 mb-0 text-end">{ui.projects2.sample_client}</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">{ui.projects2.completion_label}</p>
																		<p className="text-300 mb-0 text-end">{ui.projects2.sample_completion}</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">{ui.projects2.technologies_label}</p>
																		<p className="text-300 mb-0 text-end">{ui.projects2.sample_technologies}</p>
																	</div>
																</li>
															</ul>
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="#" className="text-300 border-bottom px-2 pb-2 link-hover">
												...
												<div className="p-lg-5 p-md-4 p-3 border mt-5 bg-3">
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<div className="d-flex flex-wrap align-items-center gap-3 mt-7">
																<Link href="#" className="text-300 border-bottom border px-2 pb-2 link-hover">
																	<svg xmlns="http://www.w3.org/2000/svg" width={13} height={13} viewBox="0 0 13 13" fill="none">
																		<path d="M11.0037 3.91421L2.39712 12.5208L0.98291 11.1066L9.5895 2.5H2.00373V0.5H13.0037V11.5H11.0037V3.91421Z" fill="#8F8F92" />
																	</svg>
																	{ui.projects2.live_demo_label}
							...
							<img className="position-absolute top-0 start-0 z-0" src="/assets/imgs/home-page-2/projects/bg.webp" alt="zelio" />
						</div>
					</div>
				</div>
			</div>
