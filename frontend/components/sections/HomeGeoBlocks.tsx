    ...
    <>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <h2 id="home-geo-tech-heading" className="ds-4 mb-3 text-white">
                {copy.techHeading}
              </h2>
              <p className="text-200 fs-5 lh-lg mb-5">{copy.techIntro}</p>
              <div className="row g-4">
                {copy.tech.map((cat) => (
                  <div className="col-md-6 col-lg-4" key={cat.category}>
                    <h3 className="fs-5 text-white mb-3">{cat.category}</h3>
                    <ul className="text-200 fs-6 mb-0 ps-3">
                      {cat.items.map((item) => (
      ...
      >
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <h2 id="home-geo-why-heading" className="ds-4 mb-5 text-white text-center">
                {copy.whyHeading}
              </h2>
                ...
                {copy.faqs.map((f, idx) => (
                  ...
                  >
                    <summary className="p-3 cursor-pointer" style={{ listStylePosition: 'outside' }}>
                      <span className="fs-5 text-white">{f.question}</span>
                    </summary>
                    <div className="px-4 pb-4">
                      <p className="text-200 mb-0 lh-lg">{f.answer}</p>
                    </div>
                  </details>
                ))}
              </div>
