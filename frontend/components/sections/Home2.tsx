...
import { normalizeUiHomeSettingValue, sanitizeHtml } from '@/integrations/shared';
		...
		<>
			...
			<section id="about" className="section-hero-2 position-relative pt-130 pb-3">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										...
										<p
											...
											dangerouslySetInnerHTML={{ __html: sanitizeHtml(copy.description_html) }}
										/>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
				...
				<div className="background position-absolute top-0 start-0 w-100 h-100">
					<img className="bg-w" src="/assets/imgs/home-page-2/hero-1/bg.webp" alt="zelio" />
					<img className="bg-d" src="/assets/imgs/home-page-2/hero-1/bg-dark.webp" alt="zelio" />
				</div>
			</section>
