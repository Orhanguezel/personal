...
export default function ServiceDetailClient({ locale, slug }: { locale: string; slug: string }) {
  ...
  const coverUrl = useMemo(() => {
    if (!svc) return '/assets/imgs/services-list/img-1.webp';
          ...
          <div className="row">
            <div className="col-lg-8 mx-lg-auto">
              <div className="text-center">
                ...
                <h1 className="ds-3 mt-3 mb-4 text-dark">{title}</h1>
                            ...
                            <div className="card__description text-300 fs-6 mb-0">
                              <div
                                dangerouslySetInnerHTML={{
                                  __html: sanitizeHtml((htmlFromJson || rawContent) as string),
                                }}
                              />
                            </div>
                          </div>
                            ...
                            {gallery
                              ...
                              .map((g) => {
                                const img =
                                  ...
                                  '/assets/imgs/services-list/img-2.webp';
