...
export default function Home3Client() {
  ...
  const typicalCards = useMemo(() => {
    ...
    return list.map((p, idx) => {
      ...
      const imgFallback = `/assets/imgs/home-page-3/typical/img-${(idx % 3) + 1}.webp`;
              ...
              <div className="col-lg-7 pt-lg-0 pt-8">
                <div id="about" className="hero-3 pe-lg-5 border-bottom pb-7">
                  ...
                  <h2
                    ...
                    dangerouslySetInnerHTML={{ __html: sanitizeHtml(ui.hero.title_html) }}
                  />
                          ...
                          educationItems.map((edu, idx) => (
                            <div key={edu.id} className={idx > 0 ? 'mt-4' : ''}>
                              <div className="icon rounded-circle overflow-hidden d-inline-block">
                                <img
                                  src={`/assets/imgs/home-page-3/education/icon-${(idx % 3) + 1}.webp`}
                                  alt="Education"
                                />
                              </div>
                          ...
                          {blogSlides.map((pair, idx) => (
                            <SwiperSlide key={idx}>
                              {pair.map((post, i) => {
                                ...
                                const imgFallback = `/assets/imgs/home-page-3/blog/img-${(i % 2) + 1}.webp`;
