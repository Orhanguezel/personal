// ===================================================================
// FILE: src/integrations/types/offers.ts
...
export const normalizeOffer = (raw: unknown): OfferView => {
  ...
  const formObj = parseJsonObject((r as any).form_data_parsed ?? r.form_data ?? null);
  ...
  return {
    ...
    consent_marketing: toBool((r as any).consent_marketing),
    consent_terms: toBool((r as any).consent_terms),

    currency: r.currency == null ? null : s(r.currency),
    net_total: toNumber(r.net_total),
    vat_rate: toNumber((r as any).vat_rate),
    vat_total: toNumber(r.vat_total),
    shipping_total: toNumber((r as any).shipping_total),
