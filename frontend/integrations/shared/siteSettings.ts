// =============================================================
// FILE: src/integrations/types/siteSettings.ts
...
export function normalizeUiServicesSettingValue(value: unknown): UiServicesCopy {
  ...
  return {
    page: {
      badge: pick(page, 'badge', 'Leistungen', 'page_badge'),
      title_html: pick(
        page,
        'title_html',
      ...
      loading: pick(page, 'loading', 'Wird geladen...', 'page_loading'),
      error: pick(page, 'error', 'Leistungen konnten nicht geladen werden.', 'page_error'),
      empty: pick(page, 'empty', 'Keine Leistungen gefunden.', 'page_empty'),
      highlight_label: pick(page, 'highlight_label', 'Schwerpunkt', 'page_highlight_label'),
      details_label: pick(page, 'details_label', 'Details', 'page_details_label'),
    },
    section1: {
      heading: pick(section1, 'heading', 'Was biete ich an?', 'section1_heading'),
      intro_html: pick(
        section1,
        'intro_html',
        'Von der Strategie bis zur Umsetzung: Websites, Schnittstellen und Automatisierungen, die Ihr Geschaeft digital voranbringen.',
        'section1_intro_html',
      ),
      error: pick(section1, 'error', 'Leistungen konnten nicht geladen werden.', 'section1_error'),
      cta_label: pick(section1, 'cta_label', 'Angebot anfragen', 'section1_cta_label'),
      empty: pick(section1, 'empty', 'Keine Leistungen gefunden.', 'section1_empty'),
      loading_title: pick(section1, 'loading_title', 'Wird geladen...', 'section1_loading_title'),
      loading_text: pick(section1, 'loading_text', 'Bitte warten', 'section1_loading_text'),
      card_fallback_title: pick(
        section1,
        'card_fallback_title',
        'Ohne Titel',
    ...
    section2: {
      badge: pick(section2, 'badge', 'Zusammenarbeit', 'section2_badge'),
      title_html: pick(
        section2,
        'title_html',
        'Loesungen <span class="text-300">passend zu Ihren<br />digitalen Zielen</span>',
        'section2_title_html',
      ),
      error: pick(section2, 'error', 'Leistungen konnten nicht geladen werden.', 'section2_error'),
      learn_more: pick(section2, 'learn_more', 'Mehr erfahren', 'section2_learn_more'),
      empty: pick(section2, 'empty', 'Keine Leistungen gefunden.', 'section2_empty'),
      loading_title: pick(section2, 'loading_title', 'Wird geladen...', 'section2_loading_title'),
      loading_text: pick(section2, 'loading_text', 'Bitte warten', 'section2_loading_text'),
      card_fallback_title: pick(
        section2,
        'card_fallback_title',
        'Ohne Titel',
      ...
      footer_text_html: pick(
        section2,
        'footer_text_html',
        'Bereit fuer <span class="text-dark">neue Projekte</span> und klare Zusammenarbeit.<br />Sprechen wir ueber Ihre Idee.',
    ...
    detail: {
      back_label: pick(detail, 'back_label', 'Zurueck zu Leistungen', 'detail_back_label'),
      loading: pick(detail, 'loading', 'Wird geladen...', 'detail_loading'),
      error: pick(detail, 'error', 'Leistung konnte nicht geladen werden.', 'detail_error'),
      highlight_label: pick(detail, 'highlight_label', 'Schwerpunkt', 'detail_highlight_label'),
      ...
      gallery_label: pick(detail, 'gallery_label', 'Galerie', 'detail_gallery_label'),
      gallery_loading: pick(detail, 'gallery_loading', 'Wird geladen...', 'detail_gallery_loading'),
      gallery_empty: pick(detail, 'gallery_empty', 'Keine Galeriebilder.', 'detail_gallery_empty'),
      not_found: pick(detail, 'not_found', 'Leistung nicht gefunden.', 'detail_not_found'),
      title_fallback: pick(detail, 'title_fallback', 'Leistung', 'detail_title_fallback'),
      tagline_fallback: pick(
        detail,
        'tagline_fallback',
        'Klar. Schnell. Wirksam.',
...
export function normalizeUiProjectSettingValue(value: unknown): UiProjectCopy {
  ...
  return {
    projects1: {
      heading: pick(projects1, 'heading', 'Ausgewählte Projekte', 'projects1_heading'),
      intro_html: pick(
        projects1,
        'intro_html',
        'Ausgewählte Websites, Plattformen und Automatisierungen aus echten Kundenprojekten.',
        'projects1_intro_html',
      ),
      cta_label: pick(projects1, 'cta_label', 'Alle Projekte ansehen', 'projects1_cta_label'),
      cta_short_label: pick(projects1, 'cta_short_label', 'Alle ansehen', 'projects1_cta_short_label'),
    },
    projects2: {
      badge: pick(projects2, 'badge', 'Projekte', 'projects2_badge'),
      heading: pick(projects2, 'heading', 'Aktuelle Arbeiten', 'projects2_heading'),
      slide_title_html: pick(
        projects2,
        'slide_title_html',
        'Webprojekt mit <br /> messbarem Geschaeftsnutzen',
        'projects2_slide_title_html',
      ),
      slide_description: pick(
        projects2,
        'slide_description',
        'Konzeption, Entwicklung und Optimierung einer performanten digitalen Loesung.',
        'projects2_slide_description',
      ),
      info_label: pick(projects2, 'info_label', 'Projektinfo', 'projects2_info_label'),
      client_label: pick(projects2, 'client_label', 'Kunde', 'projects2_client_label'),
      ...
      live_demo_label: pick(projects2, 'live_demo_label', 'Live ansehen', 'projects2_live_demo_label'),
      github_label: pick(projects2, 'github_label', 'Auf Github ansehen', 'projects2_github_label'),
      sample_client: pick(projects2, 'sample_client', 'Kundenprojekt', 'projects2_sample_client'),
    ...
    work: {
      badge: pick(work, 'badge', 'Ausgewählte Projekte', 'work_badge'),
      title_html: pick(
        work,
        'title_html',
      ...
      intro_html: pick(
        work,
        'intro_html',
        'Ein Blick auf Websites, Plattformen und Automatisierungen, die fuer reale Geschaeftsziele entwickelt wurden.',
        'work_intro_html',
      ),
      loading_title: pick(work, 'loading_title', 'Wird geladen...', 'work_loading_title'),
      label_client: pick(work, 'label_client', 'Kunde', 'work_label_client'),
      ...
      label_tools: pick(work, 'label_tools', 'Technologien', 'work_label_tools'),
      updating: pick(work, 'updating', 'Wird aktualisiert...', 'work_updating'),
      empty_title: pick(work, 'empty_title', 'Keine Projekte gefunden', 'work_empty_title'),
      empty_text: pick(
        work,
        'empty_text',
        'Bitte Projekte im Adminbereich hinzufuegen.',
        'work_empty_text',
      ),
    },
    detail: {
      loading: pick(detail, 'loading', 'Wird geladen...', 'detail_loading'),
      not_found: pick(detail, 'not_found', 'Nicht gefunden', 'detail_not_found'),
      slug_prefix: pick(detail, 'slug_prefix', 'slug:', 'detail_slug_prefix'),
      slug_missing: pick(detail, 'slug_missing', 'slug fehlt', 'detail_slug_missing'),
      badge: pick(detail, 'badge', 'Projektdetails', 'detail_badge'),
      label_client: pick(detail, 'label_client', 'Kunde', 'detail_label_client'),
      label_start: pick(detail, 'label_start', 'Start', 'detail_label_start'),
      label_complete: pick(detail, 'label_complete', 'Abschluss', 'detail_label_complete'),
      label_services: pick(detail, 'label_services', 'Leistungen', 'detail_label_services'),
      ...
      tools_label: pick(detail, 'tools_label', 'Technologien', 'detail_tools_label'),
      ...
      price_label: pick(detail, 'price_label', 'Preis', 'detail_price_label'),
      purchase_label: pick(detail, 'purchase_label', 'Jetzt kaufen', 'detail_purchase_label'),
    },
  };
}
...
export function normalizeUiResumeSettingValue(value: unknown): UiResumeCopy {
  ...
  return {
    resume1: {
      ...
      cta_label: pick(resume1, 'cta_label', 'Kontakt aufnehmen', 'resume1_cta_label'),
  ...
  return {
    home1: {
      ...
      decor_image: pick(
        home1,
        'decor_image',
        '/assets/imgs/hero/hero-1/decorate.webp',
        'home1_decor_image',
      ),
...
export function normalizeUiHome3SettingValue(value: unknown): UiHome3Copy {
  ...
  return {
    hero: {
      badge: pick(hero, 'badge', 'Webdesign, Entwicklung und Sichtbarkeit', 'hero_badge'),
      title_html: pick(
        hero,
        'title_html',
        'Websites <span class="text-dark">mit Strategie</span> und sauberer Umsetzung',
        'hero_title_html',
      ),
      description: pick(
        hero,
        'description',
        'Guezel Web Design plant, entwickelt und optimiert moderne Websites fuer Unternehmen, die online mehr Anfragen gewinnen wollen.',
        'hero_description',
      ),
      cv_label: pick(hero, 'cv_label', 'Profil herunterladen', 'hero_cv_label'),
      cv_href: pick(hero, 'cv_href', '/assets/resume.pdf', 'hero_cv_href'),
      hire_label: pick(hero, 'hire_label', 'Projekt anfragen', 'hero_hire_label'),
      hire_href: pick(hero, 'hire_href', '#contact', 'hero_hire_href'),
      hero_image: pick(hero, 'hero_image', '/assets/imgs/guezel-showcase/service_web_design_showcase.webp', 'hero_image'),
      hero_image_alt: pick(hero, 'hero_image_alt', 'Guezel Web Design Projektarbeit', 'hero_image_alt'),
      signature_image: pick(
        hero,
        'signature_image',
        '/assets/imgs/home-page-3/hero/signature.webp',
        'signature_image',
      ),
      signature_image_alt: pick(hero, 'signature_image_alt', 'Signatur', 'signature_image_alt'),
    },
    typical: {
      heading: pick(typical, 'heading', 'Ausgewählte Arbeiten', 'typical_heading'),
      empty: pick(typical, 'empty', 'Noch keine Projekte.', 'typical_empty'),
    },
    services: {
      heading: pick(services, 'heading', 'Leistungen', 'services_heading'),
      empty: pick(services, 'empty', 'Noch keine Leistungen.', 'services_empty'),
    },
    resume: {
      education_heading: pick(resume, 'education_heading', 'Ausbildung', 'resume_education_heading'),
      awards_heading: pick(resume, 'awards_heading', 'Auszeichnungen', 'resume_awards_heading'),
      empty_education: pick(
        resume,
        'empty_education',
        'Keine Ausbildungseintraege.',
        'resume_empty_education',
      ),
      empty_awards: pick(resume, 'empty_awards', 'Noch keine Auszeichnungen.', 'resume_empty_awards'),
    },
    blog: {
      heading: pick(blog, 'heading', 'Aus dem Blog', 'blog_heading'),
      empty: pick(blog, 'empty', 'Noch keine Beitraege.', 'blog_empty'),
      default_category: pick(blog, 'default_category', 'Praxis', 'blog_default_category'),
    },
    testimonials: {
      heading: pick(testimonials, 'heading', 'Kundenstimmen', 'testimonials_heading'),
      empty: pick(testimonials, 'empty', 'Noch keine Kundenstimmen.', 'testimonials_empty'),
    },
    contact: {
      heading: pick(contact, 'heading', 'Kontakt aufnehmen', 'contact_heading'),
      form_title: pick(contact, 'form_title', 'Lassen Sie uns sprechen', 'contact_form_title'),
...
const STATIC1_FALLBACK: UiStaticItem[] = [
  {
    ...
    prefix: '+',
    label_top: 'Jahre',
    label_bottom: 'Erfahrung',
  },
  {
    value: 250,
    prefix: '+',
    label_top: 'Projekte',
    label_bottom: 'abgeschlossen',
  },
  {
    value: 680,
    prefix: '+',
    label_top: 'Zufriedene',
    label_bottom: 'Kunden',
  },
  {
    value: 18,
...
export function normalizeUiStaticSettingValue(value: unknown): UiStaticCopy {
  ...
  const background_image =
    ...
    '/assets/imgs/home-page-2/static/bg.webp';
...
export function normalizeUiBrandsSettingValue(val: unknown): UiBrandsCopy {
  ...
  const heading = uiText(o.heading) || 'Vertrauen aus echten Projekten';
  const intro_html =
    uiText(o.intro_html) ||
    'Erfahrung aus Websites, Plattformen und digitalen Prozessen fuer Unternehmen und lokale Dienstleister.';
  const track = normalizeBrandsTrack(o.track);

  const loading = uiText(o.loading) || 'Wird geladen...';
  const error = uiText(o.error) || 'Referenzen konnten nicht geladen werden.';
  const empty = uiText(o.empty) || 'Keine Referenzen gefunden.';
