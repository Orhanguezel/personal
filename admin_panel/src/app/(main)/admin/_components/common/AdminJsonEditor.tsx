...
type AdminJsonEditorProps<TValue = unknown> = {
...
export function AdminJsonEditor<TValue = unknown>({
  label,
  value,
  onChange,
  onErrorChange,
  ...
  const handleBlur = () => {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : 'Geçersiz JSON';
